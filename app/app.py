...
st.set_page_config(page_title="Data Analyst", page_icon=":rocket:", layout="wide")

# TITLE SECTION
with st.container():
    st.subheader("Hello there 👋")
    st.title("Welcome to Data Analyst!")
...
with st.container():
    ...
    with left_column_r1:
        st.header("What can Data Analyst do?")
